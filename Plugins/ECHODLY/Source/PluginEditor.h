...
namespace PC {
    inline const juce::Colour bg   { 0xffEC7DBB };
    inline const juce::Colour ring { 0xffE63B7A };
    inline const juce::Colour face { 0xffF1C9FE };
    inline const juce::Colour ndl  { 0xffB92D5D };
    inline const juce::Colour lbl  { 0xffDAEEF2 };
}

class ECHODLYLAF : public juce::LookAndFeel_V4 {
public:
    ECHODLYLAF(){
...
class ECHODLYEditor : public juce::AudioProcessorEditor {
public:
    explicit ECHODLYEditor(ECHODLYProcessor&);
    ~ECHODLYEditor() override;
    void paint(juce::Graphics&) override;
    void resized() override;
private:
    ECHODLYProcessor& proc;
    ECHODLYLAF laf;
    ...
    juce::Slider param5Knob{juce::Slider::RotaryHorizontalVerticalDrag,juce::Slider::NoTextBox};
    juce::Slider param6Knob{juce::Slider::RotaryHorizontalVerticalDrag,juce::Slider::NoTextBox};
    juce::Slider preSlider{juce::Slider::LinearVertical,juce::Slider::NoTextBox};
    juce::Slider dampSlider{juce::Slider::LinearVertical,juce::Slider::NoTextBox};
    juce::Slider param7Slider{juce::Slider::LinearVertical,juce::Slider::NoTextBox};
    juce::Label mixLbl;
    juce::Label sizeLbl;
    juce::Label preLbl;
    juce::Label dampLbl;
    juce::Label param5Lbl;
    juce::Label param6Lbl;
    juce::Label param7Lbl;
    ...
    std::unique_ptr<Att> preAtt;
    std::unique_ptr<Att> dampAtt;
    std::unique_ptr<Att> param5Att;
    std::unique_ptr<Att> param6Att;
    std::unique_ptr<Att> param7Att;
    void setupLbl(juce::Label&,const juce::String&);
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ECHODLYEditor)
};